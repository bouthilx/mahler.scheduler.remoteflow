# -*- coding: utf-8 -*-
#
# mahler.scheduler.remoteflow documentation build configuration file.
#
...
import mahler.scheduler.remoteflow as scheduler_plugin
...
project = u'mahler.scheduler.remoteflow'
...
htmlhelp_basename = 'remoteflowdoc'
...
latex_documents = [
  (master_doc, 'mahler.scheduler.remoteflow.tex',
   u'Mahler scheduler remoteflow Documentation',
...
texinfo_documents = [
  (master_doc, 'remoteflow',
   u'Mahler scheduler remoteflow Documentation',
   author, 'remoteflow', scheduler_plugin.__descr__,
   'Miscellaneous'),
]
